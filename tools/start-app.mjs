...
// Some shells set ELECTRON_RUN_AS_NODE, which makes the electron binary behave as a plain
// Node CLI instead of launching the Electron GUI runtime - drop it explicitly.
